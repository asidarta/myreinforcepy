...
# -*- coding: utf-8 -*-
"""
Created on Dec 2017 [ based on Floris' example code; and modified by Darainy ]
This code is used to perform visual calibration. 
Do it when you fear there is a shift in the display w.r.t the robot arm.
